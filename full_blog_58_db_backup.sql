...
-- Dumping database structure for full_blog_58
DROP DATABASE IF EXISTS `full_blog_58`;
CREATE DATABASE IF NOT EXISTS `full_blog_58` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `full_blog_58`;

-- Dumping structure for table full_blog_58.categories
...
-- Dumping data for table full_blog_58.categories: ~4 rows (approximately)
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
INSERT INTO `categories` (`id`, `name`, `slug`, `image`, `created_at`, `updated_at`) VALUES
	(1, 'Laravel Framework', 'laravel-framework', 'laravel-framework-2019-11-20-5dd498b869a91.png', '2019-11-20 01:36:56', '2019-11-20 01:36:56'),
	(2, 'Codeigniter Framework', 'codeigniter-framework', 'codeigniter-framework-2019-11-20-5dd498f1a0a8a.png', '2019-11-20 01:37:54', '2019-11-20 01:37:54'),
	(3, 'Angular Framework', 'angular-framework', 'angular-framework-2019-11-20-5dd49902a25c7.png', '2019-11-20 01:38:11', '2019-11-20 01:38:11'),
	(4, 'VueJs Framework', 'vuejs-framework', 'vuejs-framework-2019-11-20-5dd49913a7f85.jpeg', '2019-11-20 01:38:28', '2019-11-20 01:38:28'),
	(5, 'PHP Basic', 'php-basic', 'php-basic-2019-11-20-5dd4992987127.jpg', '2019-11-20 01:38:50', '2019-11-20 01:38:50');
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;

-- Dumping structure for table full_blog_58.category_post
...
-- Dumping data for table full_blog_58.category_post: ~19 rows (approximately)
/*!40000 ALTER TABLE `category_post` DISABLE KEYS */;
INSERT INTO `category_post` (`id`, `post_id`, `category_id`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, '2018-09-24 08:55:49', '2018-09-24 08:55:49'),
	(2, 1, 3, '2018-09-24 08:55:49', '2018-09-24 08:55:49'),
	(3, 2, 2, '2018-09-24 08:56:37', '2018-09-24 08:56:37'),
	(4, 2, 3, '2018-09-24 08:56:37', '2018-09-24 08:56:37'),
	(5, 3, 3, '2018-09-24 09:01:52', '2018-09-24 09:01:52'),
	(6, 4, 4, '2018-09-24 09:03:34', '2018-09-24 09:03:34'),
	(7, 5, 4, '2018-09-24 09:04:14', '2018-09-24 09:04:14'),
	(8, 6, 1, '2018-09-24 09:04:54', '2018-09-24 09:04:54'),
	(9, 6, 2, '2018-09-24 09:04:54', '2018-09-24 09:04:54'),
	(10, 6, 3, '2018-09-24 09:04:54', '2018-09-24 09:04:54'),
	(11, 7, 1, '2018-09-24 09:05:39', '2018-09-24 09:05:39'),
	(12, 7, 3, '2018-09-24 09:05:39', '2018-09-24 09:05:39'),
	(13, 8, 1, '2018-09-24 09:07:22', '2018-09-24 09:07:22'),
	(14, 8, 2, '2018-09-24 09:07:22', '2018-09-24 09:07:22'),
	(15, 9, 1, '2018-09-24 09:08:01', '2018-09-24 09:08:01'),
	(16, 9, 2, '2018-09-24 09:08:01', '2018-09-24 09:08:01'),
	(17, 9, 3, '2018-09-24 09:08:01', '2018-09-24 09:08:01'),
	(18, 9, 4, '2018-09-24 09:08:01', '2018-09-24 09:08:01'),
	(21, 10, 5, '2019-11-20 01:50:50', '2019-11-20 01:50:50');
/*!40000 ALTER TABLE `category_post` ENABLE KEYS */;

-- Dumping structure for table full_blog_58.comments
...
-- Dumping data for table full_blog_58.comments: ~0 rows (approximately)
/*!40000 ALTER TABLE `comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `comments` ENABLE KEYS */;

-- Dumping structure for table full_blog_58.jobs
...
-- Dumping data for table full_blog_58.jobs: ~13 rows (approximately)
...
-- Dumping structure for table full_blog_58.migrations
...
-- Dumping data for table full_blog_58.migrations: ~12 rows (approximately)
...
-- Dumping structure for table full_blog_58.password_resets
...
-- Dumping data for table full_blog_58.password_resets: ~0 rows (approximately)
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;

-- Dumping structure for table full_blog_58.posts
...
-- Dumping data for table full_blog_58.post_tag: ~20 rows (approximately)
/*!40000 ALTER TABLE `post_tag` DISABLE KEYS */;
INSERT INTO `post_tag` (`id`, `post_id`, `tag_id`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, '2018-09-24 08:55:49', '2018-09-24 08:55:49'),
	(2, 2, 2, '2018-09-24 08:56:37', '2018-09-24 08:56:37'),
	(3, 3, 3, '2018-09-24 09:01:52', '2018-09-24 09:01:52'),
	(4, 3, 4, '2018-09-24 09:01:52', '2018-09-24 09:01:52'),
	(5, 4, 4, '2018-09-24 09:03:35', '2018-09-24 09:03:35'),
	(6, 4, 6, '2018-09-24 09:03:35', '2018-09-24 09:03:35'),
	(7, 5, 4, '2018-09-24 09:04:14', '2018-09-24 09:04:14'),
	(9, 6, 2, '2018-09-24 09:04:54', '2018-09-24 09:04:54'),
	(10, 6, 4, '2018-09-24 09:04:54', '2018-09-24 09:04:54'),
	(11, 6, 5, '2018-09-24 09:04:54', '2018-09-24 09:04:54'),
	(12, 7, 1, '2018-09-24 09:05:39', '2018-09-24 09:05:39'),
	(13, 7, 2, '2018-09-24 09:05:39', '2018-09-24 09:05:39'),
	(14, 7, 5, '2018-09-24 09:05:39', '2018-09-24 09:05:39'),
	(15, 8, 2, '2018-09-24 09:07:22', '2018-09-24 09:07:22'),
	(16, 9, 3, '2018-09-24 09:08:01', '2018-09-24 09:08:01'),
	(17, 9, 4, '2018-09-24 09:08:01', '2018-09-24 09:08:01'),
	(18, 9, 6, '2018-09-24 09:08:01', '2018-09-24 09:08:01'),
	(19, 10, 1, '2018-10-28 09:24:23', '2018-10-28 09:24:23'),
	(20, 10, 3, '2018-10-28 09:24:23', '2018-10-28 09:24:23'),
	(21, 5, 6, '2019-11-20 01:52:00', '2019-11-20 01:52:00');
/*!40000 ALTER TABLE `post_tag` ENABLE KEYS */;

-- Dumping structure for table full_blog_58.post_user
...
-- Dumping data for table full_blog_58.post_user: ~7 rows (approximately)
/*!40000 ALTER TABLE `post_user` DISABLE KEYS */;
INSERT INTO `post_user` (`id`, `post_id`, `user_id`, `created_at`, `updated_at`) VALUES
	(1, 9, 2, '2018-09-24 10:54:31', '2018-09-24 10:54:31'),
	(2, 8, 2, '2018-09-24 11:02:10', '2018-09-24 11:02:10'),
	(5, 5, 1, '2018-09-25 02:51:13', '2018-09-25 02:51:13'),
	(6, 4, 1, '2018-09-25 02:51:23', '2018-09-25 02:51:23'),
	(8, 8, 1, '2018-09-25 02:53:41', '2018-09-25 02:53:41'),
	(9, 7, 1, '2018-09-25 02:55:39', '2018-09-25 02:55:39'),
	(11, 9, 1, '2018-09-25 06:59:16', '2018-09-25 06:59:16');
/*!40000 ALTER TABLE `post_user` ENABLE KEYS */;

-- Dumping structure for table full_blog_58.roles
...
-- Dumping data for table full_blog_58.roles: ~2 rows (approximately)
...
-- Dumping structure for table full_blog_58.subscribers
...
-- Dumping data for table full_blog_58.subscribers: ~3 rows (approximately)
/*!40000 ALTER TABLE `subscribers` DISABLE KEYS */;
INSERT INTO `subscribers` (`id`, `email`, `created_at`, `updated_at`) VALUES
	(1, 'kk@yahoo.com', '2018-09-24 09:09:46', '2018-09-24 09:09:46'),
	(2, 'bosba@gmail.com', '2018-09-24 09:09:52', '2018-09-24 09:09:52'),
	(3, 'jj@blog.com', '2018-09-24 09:10:23', '2018-09-24 09:10:23');
/*!40000 ALTER TABLE `subscribers` ENABLE KEYS */;

-- Dumping structure for table full_blog_58.tags
...
-- Dumping data for table full_blog_58.tags: ~6 rows (approximately)
/*!40000 ALTER TABLE `tags` DISABLE KEYS */;
INSERT INTO `tags` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
	(1, 'PHP', 'php', '2018-09-24 08:05:38', '2018-09-24 08:05:38'),
	(2, 'Laravel', 'laravel', '2018-09-24 08:05:48', '2018-09-24 08:05:48'),
	(3, 'Codeigniter', 'codeigniter', '2018-09-24 08:06:23', '2018-09-24 08:06:23'),
	(4, 'Framework', 'framework', '2018-09-24 08:06:39', '2018-09-24 08:06:39'),
	(5, 'React Native', 'react-native', '2018-09-24 08:06:48', '2018-09-24 08:06:48'),
	(6, 'Angular', 'angular', '2018-09-24 08:07:02', '2018-09-24 08:07:02');
/*!40000 ALTER TABLE `tags` ENABLE KEYS */;

-- Dumping structure for table full_blog_58.users
...
-- Dumping data for table full_blog_58.users: ~2 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `role_id`, `name`, `username`, `email`, `password`, `image`, `about`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 1, 'MD.Admin', 'admin', 'admin@admin.com', '$2y$10$IZqTDPsd0OdMWykVdMf4Me9MwT1Owza7OftYWRxVcGVJM.IN5ud26', 'mdadmin-2018-09-25-5ba9bda573506.jpg', 'About Admin User.', 'EMZ26BCxkePDnQ7CfhKZPoThoDcz5FcsXVBh1sHURRGk3aIbSMMvk69FEOjH', '2018-10-09 00:00:00', '2019-11-20 02:04:07'),
	(2, 2, 'MD.Author', 'author', 'author@author.com', '$2y$10$ulUf9TKq7ZWff9U0wJM/OeyZeHui2gEFydNL5bReu6C5X6zd/i5o2', 'mdauthor-2018-09-25-5ba9bdea690be.jpg', 'About Author User.', '54dj7ug7Yimqp953SsUzXaz3MwqYrK7rKf8BPwWMvPPhXzQ3iHWXcfMvB1iy', '2018-10-02 00:00:00', '2019-11-20 02:05:06');
